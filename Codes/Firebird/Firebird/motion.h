...
//this fucntion on giving a destination,present position 
//tells which direction to move to reach the destinations
...
/**********************************************************************
The standard dfs implementation. But here we prefer to take a shorter 
path based on the pres and dest value.
************************************************************************/
